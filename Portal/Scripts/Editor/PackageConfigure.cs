...
{
    private static string[] _tags = { "BlueGem","OrangeGem","screen","CinemachineTarget","draggable","Gembag","HexagonTile","PinkGem","PurpleGem", "Esfera", "Desactivador", "Negativo", "Base", "Footsteps Grass", "Footsteps Gravel", "Footsteps Metal", "Footsteps Rock", "Footsteps Sand", "Footsteps Snow", "Footsteps Tile", "Footsteps Water", "Footsteps Wood", "Footsteps Mud" };
